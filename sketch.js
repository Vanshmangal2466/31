...
function setup() {
  ...
  plinko=new Plinko(500,100,15,30);
  plinko1=new Plinko(500,250,15,30);
  plinko2=new Plinko(500,400,15,30);
  plinko3=new Plinko(300,250,15,30);
  plinko4=new Plinko(300,400,15,30);
  plinko5=new Plinko(300,100,15,30);

  pli=new Plinko(100,100,15,30);
  pli1=new Plinko(100,250,15,30);
  pli2=new Plinko(100,400,15,30);
  pli3=new Plinko(700,100,15,30);
  pli4=new Plinko(700,250,15,30);
  pli5=new Plinko(700,400,15,30);
